...
val defaultBrowserColumns = listOf(
    ...
    BrowserColumn("kanji", "Kanji", isVisible = true, width = 80, alignment = ColumnAlignment.Center),
    BrowserColumn("reading", "Reading", isVisible = true, width = 120),
    BrowserColumn("meaning", "Meaning", isVisible = true, width = 180),
    BrowserColumn("deck", "Deck", isVisible = true, width = 120),
    BrowserColumn("tags", "Tags", isVisible = true, width = 120),
